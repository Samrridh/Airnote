...
Airnote is a fun, educational app that uses real-time aircraft tracking data to detect planes flying and randomly asks the capital of that aircraft origin country 
